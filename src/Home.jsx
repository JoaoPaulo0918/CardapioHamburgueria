    ...
    return (
        <>
            ...
            <div className="flex w-screen h-full font-sans py-5 px-4 justify-center bg-orange-950">
                ...
                <nav className="fixed top-0 w-full h-14 bg-orange-950 px-6 flex items-center justify-between z-20 shadow pt-safe-offset">
                ...
                <div className="flex flex-col mt-9 h-full w-full  rounded-2xl text-orange-950 items-center gap-3 lg:gap-5">
                    ...
                    <div className=" w-full h-48 px-6 md:px-10 py-3 flex flex-col justify-center items-center gap-3 mt-9 mb-8 sm:mt-14 sm:mb-4">
